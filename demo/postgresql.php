<?php
	/*
	 * Ejemplo de utilización de la biblioteca Ksike/Secretary para conexión a base de datos PostgreSQL
	 * */
	...
	$config["log"]		 = "log/";
    $config["driver"]	 = "pgsql";			//... valores admitidos: pgsql|mysql|mysqli|sqlite|sqlsrv
	$config["name"]		 = "ploy";		    //... nombre de la base de datos a la cual debe conectarse
	$config["host"]		 = "127.0.0.1";		//... IP del servidor, valor por defecto localhost
	$config["user"]		 = "root";			//... usuario de la base de datos, valor por defecto postgres
	$config["pass"]		 = "root1A";		//... contraseña para establecer la conexión, valor por defecto postgres
	$config["port"]		 = "5432";			//... puerto para establecer la conexión, valor por defecto 5432
